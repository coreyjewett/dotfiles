    ...
    sh -c "`curl -fsSL https://raw.github.com/coreyjewett/dotfiles/master/install.sh`"
...
```bash
sh -c "`curl -fsSL https://raw.github.com/coreyjewett/dotfiles/master/install.sh`" -s ask
```
